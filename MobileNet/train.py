...
def main():
    ...
    def get_pretrained_mobilenet_v2():
    ...
    def get_pretrained_mobilenet_v3_large():
    ...
    if fine_tune:
        net = get_pretrained_mobilenet_v3_large().to(device)
    else:
    ...
    optimizer = optim.Adam(params, lr=2e-3, weight_decay=1e-5)
